...
namespace Anatomy.Scripts.ARCoreScripts.ManipulationSystem
{
    ...
    public class SelectionManipulator : Manipulator
    {
        ...
        //TODO: change UI depends on selected object
        /// <summary>
        /// Function called when this game object is deselected if it was the Selected Object.
        /// </summary>
        protected override void OnSelected(GameObject selectedObject)
        {
            if(selectedObject != null)
            {
                var anatomyObjectManager = FindObjectOfType<AnatomyObjectManager>();
                if(anatomyObjectManager != null)
                {
                    anatomyObjectManager.OnObjectSelected(selectedObject);
                }
            }
        ...
        /// Function called when this game object is deselected if it was the Selected Object.
        /// </summary>
        protected override void OnDeselected(GameObject deselectedObject)
        {
            if(deselectedObject != null)
            {
                var anatomyObjectManager = FindObjectOfType<AnatomyObjectManager>();
                if(anatomyObjectManager != null)
                    anatomyObjectManager.OnObjectDeselected(deselectedObject);
            }
