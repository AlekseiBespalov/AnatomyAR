...
namespace Anatomy.Scripts.ARCoreScripts.ManipulationSystem
{
    ...
    public class ManipulationSystem : MonoBehaviour
    {
        ...
        public delegate void ObjectRemovedHandler(GameObject removedObject);
        ...
        public void DestroyObject()
        {
            ...
            {
                OnObjectRemoved(SelectedObject);
                Destroy(SelectedObject);
                Deselect();
                m_ObjectManipulator.CurrentCountOfObjects -= 1;
            }
        }

        protected virtual void OnObjectRemoved(GameObject removedObject)
        {
