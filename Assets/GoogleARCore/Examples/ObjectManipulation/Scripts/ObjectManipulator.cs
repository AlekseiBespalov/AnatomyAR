...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class ObjectManipulator : Manipulator
    {
        ...
        /// </summary>
        /// <param name="objectNumber">Chosen prefab by pressed button</param>
        public void ChoosePrefab(int objectNumber)
        {
            SelectedObject = objectNumber;
            Debug.Log($"Prefab №{ objectNumber } is selected to spawn");
        }
        ...
        protected override void OnEndManipulation(TapGesture gesture)
        {
                ...
                gesture.StartPosition.x, gesture.StartPosition.y, raycastFilter, out hit))
            {
                ...
                else
                {
                    ...
                    var gameObject = Instantiate(ObjectsToSpawn[SelectedObject] , hit.Pose.position, hit.Pose.rotation);
